    ...
    <li class="list-group-item d-flex align-items-center">
      <div class="col-lg-10">
       ...
       <img src="{{$path}}" width="50" height="50"/>
        ...
        <strong></strong>
        <?php
        $img=$classement11->equipe->idComposante;
        $pathimg;
        if($img==1){
      ...
      elseif($img==3){
        ...
        <strong>{{$classement11->equipe->NomEquipe}}</strong>
        {{$classement11->equipe->Slogan}}
      </div>        
      <div class="col text-end">
        <a href="{{route('classement11.show', $classement11->id)}}" class="btn btn-sm btn-primary mb-1"><i class="bi bi-aspect-ratio"></i></a>
      </div>
      &nbsp;
      @auth
      @can('admin')
